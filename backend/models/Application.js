...
const ApplicationSchema = new mongoose.Schema(
  {
    ...
    personalInfo: {
      ...
      email: {
        ...
        match: [
          /^[^\s@]+@[^\s@]+\.[^\s@]+$/,
          "Please provide a valid structural operational email address",
        ],
      },
      phone: {
        type: String,
      ...
      faydaId: {
        ...
        match: [
          /^\d{16}$/,
          "National Digital Fayda ID must contain precisely 16 metric digits",
        ],
      },
    ...
    trackingId: {
      ...
      unique: true,
      default: () =>
        `SidaMOV-${Math.random().toString(36).substring(2, 11).toUpperCase()}`,
    },

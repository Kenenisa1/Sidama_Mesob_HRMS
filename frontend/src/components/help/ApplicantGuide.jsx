  ...
  return (
    ...
    >
      ...
      >
        ...
        <h2 className="text-4xl font-black text-white uppercase tracking-tight">{t('help.appGuide')}</h2>
      </motion.div>
      ...
      <div className="space-y-6">
        ...
        >
          <div className="flex flex-col md:flex-row gap-8">
            <span className="bg-emerald-600 text-white text-xs font-black px-4 py-2 rounded-lg h-fit uppercase">{t('help.step1')}</span>
            <div>
              <h4 className="text-2xl font-bold text-white mb-3">{t('help.step1Title')}</h4>
              ...
              >
                {t('help.step1Bullets', { returnObjects: true }).map((text, idx) => (
                  <motion.li 
                    key={idx}
        ...
        >
          <div className="flex flex-col md:flex-row gap-8">
            <span className="bg-emerald-600 text-white text-xs font-black px-4 py-2 rounded-lg h-fit uppercase">{t('help.step2')}</span>
            <div className="flex-1 space-y-6">
              <div>
                <h4 className="text-2xl font-bold text-white mb-3">{t('help.step2Title')}</h4>
                <p className="text-zinc-400 text-lg leading-relaxed">
                  {t('help.step2Desc')}
                </p>
              </div>
              ...
              >
                ...
                <DocItem label={t('help.docDegree')} desc={t('help.docDegreeDesc')} />
        ...
        >
          <div className="flex flex-col md:flex-row gap-8">
            <span className="bg-emerald-600 text-white text-xs font-black px-4 py-2 rounded-lg h-fit uppercase">{t('help.step3')}</span>
            <div>
              <h4 className="text-2xl font-bold text-white mb-3">{t('help.step3Title')}</h4>
              <p className="text-zinc-400 text-lg leading-relaxed">
                {t('help.step3Desc')}
              </p>
              ...
              <motion.ul 
                ...
                className="space-y-3 mt-5"
              >
                {t('help.step3Bullets', { returnObjects: true }).map((text, idx) => (
                  <motion.li 
                    key={idx}
                    variants={listItemVariants}
                    className="flex items-start gap-3 text-gray-300"

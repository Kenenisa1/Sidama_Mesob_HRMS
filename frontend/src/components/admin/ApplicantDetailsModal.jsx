...
const ApplicantDetailsModal = ({
  ...
  const handleStatusChange = async (newStatus) => {
    try {
      ...
      await axios.put(`/api/applications/${applicant._id}/status`, {
        status: newStatus,
      });
      ...
      setErrorMessage(
        err.response?.data?.message ||
          "Failed to update candidate progression state.",
      );
    } finally {
      setIsUpdating(false);
    }
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/95 backdrop-blur-md p-4 md:p-6 animate-[fadeIn_0.2s_ease-out] selection:bg-emerald-500/20">
      <div className="w-full max-w-4xl h-[90vh] md:h-[85vh] bg-[var(--bg)] border border-[var(--nav-border)] rounded-2xl shadow-[0_0_80px_-20px_rgba(16,185,129,0.08)] overflow-hidden flex flex-col relative">
        ...
        <div className="flex items-center justify-between px-6 py-4 border-b border-zinc-900 bg-[#030303] shrink-0">
            ...
            <div>
              ...
              <p className="text-[10px] text-zinc-500 font-mono tracking-wider mt-0.5 uppercase">
                ...
                <span className="text-[var(--color-text-primary)] font-bold">
                  {vacancyTitle || "General Registry Operations"}
                </span>
              </p>
            </div>
          </div>
          <button
            type="button"
            onClick={onClose}
            className="text-[var(--color-text-secondary)] hover:text-[var(--color-text-primary)] p-2 rounded-xl bg-[var(--color-surface)]/30 hover:bg-[var(--color-surface)] border border-[var(--nav-border)] transition-colors cursor-pointer"
        ...
        <div className="p-6 md:p-8 space-y-10 overflow-y-auto flex-1 bg-gradient-to-b from-[#000000] via-[#010101] to-[#000000] scroll-smooth">
            ...
            <div className="bg-[#030303] border border-zinc-900 rounded-xl p-4 font-mono text-[10px] space-y-2.5 shadow-[0_4px_20px_rgba(0,0,0,0.4)]">
              <div className="flex items-center gap-2 text-zinc-400">
                ...
                <span className="truncate">
                  {applicant.email || "kenenisaimieso@gmail.com"}
                </span>
              </div>
              <div className="flex items-center gap-2 text-zinc-400">
                <svg
          ...
          <div className="space-y-3">
            ...
            <div className="bg-[#030303] border border-zinc-900 p-5 rounded-xl text-xs text-zinc-300 leading-relaxed whitespace-pre-wrap font-normal shadow-inner">
              {applicant.coverLetter ||
                "Highly analytical Software Engineering specialist with comprehensive codebase execution capabilities centered around Next.js, React, and robust architecture optimization over the MERN stack. Committed to accelerating high-volume data arrays and rendering sleek, responsive dashboards via modular code compilation paradigms."}
            </div>
          </div>
          ...
          <div className="space-y-4">
            ...
            <div className="w-full bg-[#030303] border border-zinc-900 rounded-xl overflow-hidden shadow-[0_12px_40px_rgba(0,0,0,0.7)]">
              <div className="w-full bg-[var(--bg)] p-8 md:p-12 space-y-8 relative">
                ...
                <div className="border-l-4 border-emerald-500 pl-4 space-y-1">
                  <h2 className="text-xl md:text-2xl font-black text-[var(--color-text-primary)] tracking-tight uppercase">
                    {applicant.fullName || "Kenenisa Mieso"}
                  </h2>
                  <p className="text-xs font-mono text-emerald-400 font-extrabold tracking-widest uppercase">
                    Software Engineer — Specialist in Next.js & MERN Stack
                    Systems
                  </p>
                </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-8 pt-4 border-t border-zinc-900">
                  ...
                  <div className="space-y-6 md:border-r md:border-zinc-900/60 md:pr-6">
                    <div className="space-y-2">
                      <h4 className="text-[9px] font-mono font-black text-zinc-500 uppercase tracking-widest">
                        Academic Origin
                      </h4>
                      <p className="text-xs text-zinc-200 font-bold font-sans">
                        Arba Minch University
                      </p>
                      <p className="text-[10px] text-zinc-400 font-mono">
                        B.Sc. Software Engineering Node (4th Year)
                      </p>
                    </div>
                    <div className="space-y-2">
                      <h4 className="text-[9px] font-mono font-black text-zinc-500 uppercase tracking-widest">
                      ...
                      <div className="flex flex-wrap gap-1.5 pt-1">
                        {[
                          ...
                          <span
                            key={tech}
                            className="text-[8px] font-mono text-zinc-300 bg-zinc-900 border border-zinc-800 px-2 py-0.5 rounded"
                          >
                            {tech}
                          </span>
                        ))}
                  ...
                  <div className="md:col-span-2 space-y-6">
                    <div className="space-y-3">
                      <h4 className="text-[9px] font-mono font-black text-zinc-500 uppercase tracking-widest">
                        Core Production Deployments & Systems
                      </h4>
                      ...
                      <div className="space-y-1">
                        ...
                        <p className="text-[11px] text-zinc-400 leading-relaxed font-sans">
                          Architected an ultra-fast digital window-shopping
                          portal tool infrastructure. Integrated customized
                          deployment paradigms on Vercel and configured strict
                      ...
                      <div className="space-y-1 pt-2">
                        ...
                        <p className="text-[11px] text-zinc-400 leading-relaxed font-sans">
                          Developed advanced technical requirement frameworks,
                          precise API route schema contracts, and beautiful
                          high-performance enterprise admin panels for localized
                          municipal digitization.
                        </p>
                      </div>
                      ...
                      <div className="space-y-1 pt-2">
                        <div className="flex justify-between items-center">
                          <h5 className="text-xs font-bold text-zinc-100">
                            Personal Finance & Embedded Switched Arrays
                          </h5>
                        ...
                        <p className="text-[11px] text-zinc-400 leading-relaxed font-sans">
                          Engineered local Android storage systems utilizing
                          SQLite environments alongside low-level Arduino
                          micro-controlled smart switch automation hardware
                          modules.
                        </p>
                      </div>
                    </div>
              ...
              <div className="p-4 bg-[#050505] flex flex-col md:flex-row md:justify-between items-start md:items-center gap-4 border-t border-zinc-900">
                <div>
                  <h5 className="text-xs font-mono font-bold text-zinc-300">
                    Curriculum Vitae
                  </h5>
                  <p className="text-[10px] text-zinc-500 font-mono">
                    Download the uploaded CV file for this applicant.
                  </p>
                </div>
                <a
                  href={`/api/uploads/${applicant.documents?.cv || "mock-resume.pdf"}`}
                  target="_blank"
                  rel="noopener noreferrer"
                  className="inline-flex items-center gap-2 px-3 py-1.5 bg-[var(--color-surface)] hover:bg-[var(--color-surface)]/70 border border-[var(--nav-border)] text-[10px] font-mono text-[var(--color-text-secondary)] hover:text-[var(--color-text-primary)] rounded-xl transition-colors cursor-pointer"
                >
                  <svg
                    className="w-3 h-3"
                    fill="none"
          ...
          <div className="space-y-4">
              ...
              <div className="bg-[#030303] border border-zinc-900 rounded-xl overflow-hidden flex flex-col group hover:border-zinc-800 transition-all duration-200">
                <div className="relative aspect-[16/10] w-full bg-[#000000] border-b border-zinc-900 flex flex-col justify-between p-5 overflow-hidden">
                  ...
                  <div className="text-center my-auto space-y-2">
                    ...
                    <h4 className="text-xs font-mono font-black text-zinc-200 uppercase tracking-wide">
                      Official Degree Credential
                    </h4>
                    <p className="text-[10px] text-zinc-500 font-sans max-w-[240px] mx-auto">
                      The uploaded degree certificate associated with this
                      application.
                    </p>
                  </div>
                  ...
                  <div className="flex justify-between text-[7px] font-mono text-zinc-600 border-t border-zinc-900/60 pt-2">
                    ...
                    <span className="text-emerald-500/60 font-bold">READY</span>
                  </div>
                </div>
                <div className="p-3 bg-[#050505] flex justify-between items-center text-[10px] font-mono text-zinc-400">
                  ...
                  <a
                    href={`/api/uploads/${applicant.documents?.degreeCertificate || "mock-cert.pdf"}`}
                    target="_blank"
                    rel="noopener noreferrer"
              ...
              <div className="bg-[#030303] border border-zinc-900 rounded-xl overflow-hidden flex flex-col group hover:border-zinc-800 transition-all duration-200">
                <div className="relative aspect-[16/10] w-full bg-[#000000] border-b border-zinc-900 flex flex-col justify-between p-5 overflow-hidden">
                  ...
                  <div className="text-center my-auto space-y-2">
                    ...
                    <h4 className="text-xs font-mono font-black text-zinc-200 uppercase tracking-wide">
                      National ID / Kebele ID Copy
                    </h4>
                    <p className="text-[10px] text-zinc-500 font-sans max-w-[240px] mx-auto">
                      The identification document submitted with this
                      application.
                    </p>
                  </div>

                  <div className="flex justify-between text-[7px] font-mono text-zinc-600 border-t border-zinc-900/60 pt-2">
                    <span>Verification Asset</span>
                    <span className="text-zinc-400 font-bold">SECURE</span>
                  </div>
                </div>
                <div className="p-3 bg-[#050505] flex justify-between items-center text-[10px] font-mono text-zinc-400">
                  <span>ID_Copy.pdf</span>
                  <a
                    href={`/api/uploads/${applicant.documents?.nationalIdCopy || "mock-schol.png"}`}
                    target="_blank"
                    rel="noopener noreferrer"
                    className="text-zinc-500 hover:text-white"
                  >
            ...
            <div className="space-y-3">
              <div className="flex items-center gap-2 text-zinc-500 font-mono text-[10px] uppercase tracking-widest font-black">
                <span>[04] Supplemental Uploaded Certificates</span>
                <div className="flex-1 h-[1px] bg-zinc-900" />
              </div>
              <div className="grid grid-cols-1 gap-3">
                {applicant.documents?.otherCertificates?.length > 0 ? (
                  applicant.documents.otherCertificates.map((cert, index) => (
                    <a
                      key={index}
                      href={`/api/uploads/${cert}`}
                      target="_blank"
                      rel="noopener noreferrer"
                      className="flex items-center justify-between gap-3 px-4 py-3 border border-zinc-900 rounded-2xl bg-[#020202] text-[10px] text-zinc-300 hover:border-emerald-500/30 hover:text-white transition-colors"
                    >
                      <span className="truncate">
                        Supplemental Certificate {index + 1}
                      </span>
                      <svg
                  ...
                  <div className="px-4 py-3 border border-zinc-900 rounded-2xl bg-[#020202] text-[10px] text-zinc-500">
                    No supplemental certificate uploads were submitted with this
                    application.
                  </div>
                )}
              </div>

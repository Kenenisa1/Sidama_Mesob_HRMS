      ...
      <main className="relative max-w-6xl mx-auto px-6 py-20">
        ...
        <section className="text-center mb-24">
          ...
          <FadeIn>
            ...
            <p className="text-lg md:text-xl text-slate-400 max-w-3xl mx-auto leading-relaxed">
              SidaMOV is transforming how government serves the people of Sidama
              through{" "}
        ...
        <FadeIn>
          <section className="relative overflow-hidden p-12 rounded-[2.5rem] border border-emerald-500/20 bg-gradient-to-b from-emerald-900/10 to-transparent text-center">
            ...
            <p className="text-slate-500 mb-12">
              Leading the way in sustainable government operations
            </p>
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-10">
              {[
                ...
                <div
                  key={i}
                  className="bg-[var(--color-surface)]/30 p-8 rounded-2xl border border-[var(--nav-border)]/30"
                >
            ...
            <div className="inline-block px-6 py-3 rounded-xl bg-emerald-500/5 border border-emerald-500/10 text-emerald-400 text-sm">
              <span className="font-bold">Environmental Impact:</span> By going
              paperless, SidaMOV saves approximately 50,000 sheets of paper
              annually.
            </div>
          </section>
        </FadeIn>
        ...
        <footer className="mt-24 text-center">
          <FadeIn>
            <h2 className="text-2xl font-bold text-[var(--color-text-primary)] mb-2 font-mono">
              Get in Touch
            </h2>

  ...
  const sections = [
    {
      ...
      content: (
        <>
          <p className="mb-3">
            Welcome to the Sidama Mesob HRMS Portal.
            By accessing or using this platform, you
            agree to comply with these Terms &
            Conditions together with all applicable
            regional and federal laws.
          </p>

          <p>
            If you disagree with any of these terms,
            please discontinue using the portal
            immediately.
          </p>
        </>
      ),
...

    {
      ...
      content: (
        <>
          <p className="mb-3">
            To apply through this portal, users must:
          </p>

          <ul className="list-disc pl-5 space-y-2 text-slate-400">
            <li>
              Meet legal working age requirements.
            </li>

            <li>
              Submit authentic educational and
          ...
          <div className="mt-5 bg-amber-500/5 border border-amber-500/15 rounded-2xl p-4 flex gap-3">
            ...
            <p className="text-sm text-amber-200 leading-7">
              Providing fraudulent documents or false
              information may result in permanent
      ...
      content: (
        <>
          ...
          <ul className="list-disc pl-5 space-y-2 text-slate-400">
            ...
            <li>
              Avoid sharing passwords with third
              parties.
            </li>
...

    {
      ...
      content: (
        <>
          <p className="mb-3">
            Users must interact responsibly with the
            HRMS platform and agree not to:
          </p>

          <ul className="list-disc pl-5 space-y-2 text-slate-400">
            <li>
              Use automated scraping or hacking tools.
            </li>

            <li>
              Upload malicious or corrupted files.
            </li>

            <li>
              Attempt unauthorized access to system
              infrastructure.
            </li>
...

    {
      ...
      content: (
        <>
          <p className="mb-3">
            All branding, visual assets, source code,
            and digital content belong exclusively to
            Sidama Mesob Unity Center (SMUC).
          </p>

          <p>
            Users receive limited permission to access
            the portal strictly for legitimate HR and
...

    {
      ...
      content: (
        <>
          <p className="mb-3">
            The HRMS portal is provided on an
          ...
          <ul className="list-disc pl-5 space-y-2 text-slate-400 mb-3">
            <li>
              Temporary outages may occur during
              maintenance or network issues.
            </li>

            <li>
              Some uploaded files may fail due to
              incompatible formats.
            </li>
          </ul>

          <p>
            SMUC shall not be liable for damages
            caused by temporary inaccessibility of the
            system.
          </p>
        </>
      ),
...

    {
      ...
      content: (
        <>
          <p>
            These terms are governed by Ethiopian
            federal and regional laws. Any disputes
            arising from the use of this portal shall
            be resolved through the competent courts
            within Sidama Regional State.
          </p>
        </>
      ),
    },
        ...
        <section className="text-center mb-14">
          ...
          <FadeIn>
            ...
            <p className="text-slate-400 text-sm sm:text-base max-w-3xl mx-auto leading-8">
              Please carefully review these legal
              terms before using the SMUC Human
              Resource Management System and digital
            ...
            ">
              ...
              <div>
                ...
                <p className="max-w-2xl leading-8 font-medium">
                  Contact our compliance and legal
                  support team for clarification about
                  recruitment policies, digital usage,

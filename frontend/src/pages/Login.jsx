  ...
  return (
    <div className="min-h-screen flex items-center justify-center 
      ...
      <div className="w-full max-w-lg p-8 rounded-2xl 
            bg-gradient-to-r from-[#020c17] via-[#052e2b] to-[#020c17] 
            border border-gray-800 shadow-xl backdrop-blur-md">
            ...
            <form onSubmit={handleSubmit} className="space-y-5">
              ...
              {/* Email */}
              <div className="flex items-center border border-gray-700 rounded-xl px-4 py-3 
                bg-[#020617] focus-within:ring-2 focus-within:ring-green-500">

...
const PrivacyPolicy = () => {
  ...
  const sections = [
    {
      ...
      content: (
        <>
          <p className="mb-3">
            At the Sidama Mesob Unity Center (SMUC), we take your
            privacy and data security seriously. This Privacy Policy
            details how our Human Resource Management System (HRMS)
            collects, processes, protects, and discloses personal
            information when you use the hiring portal.
          </p>

          <p>
            By submitting an application, creating an administrator
            account, or using the portal, you consent to the data
...

    {
      ...
      content: (
        <>
          <p className="mb-3">
            To provide an efficient paperless recruitment process,
            we collect the following types of information:
          </p>

          <ul className="list-disc pl-5 space-y-2 text-slate-400">
            <li>
              Full name, gender, nationality, and date of birth.
            </li>
            ...
            <li>
              Educational credentials, resumes, certificates, and
              work experience.
            </li>

            <li>
              System logs, browser data, and login timestamps for
              security monitoring.
            </li>
          </ul>
        </>
...

    {
      ...
      content: (
        <>
          <p className="mb-3">
            We use your information strictly for recruitment and
          ...
          <ul className="list-disc pl-5 space-y-2 text-slate-400">
            ...
            <li>
              Sending interview notifications and status updates.
            </li>
            ...
            <li>
              Improving digital public recruitment services.
            </li>
          </ul>
        </>
      ),
...

    {
      ...
      content: (
        <>
          ...
          <ul className="list-disc pl-5 space-y-2 text-slate-400">
            <li>
              Data may be shared with authorized government offices.
            </li>

            <li>
              Information may be disclosed if legally required by
      ...
      content: (
        <>
          ...
          <ul className="list-disc pl-5 space-y-2 text-slate-400">
            ...
            <li>
              Secure server infrastructure and encrypted storage.
            </li>
...

    {
      ...
      content: (
        <>
          <p>
            The portal uses essential session cookies for secure
            authentication and maintaining user sessions. We do not
...

    {
      ...
      content: (
        <>
          <p className="mb-3">
            Applicants maintain rights regarding their personal
            information and records.
          </p>

          <ul className="list-disc pl-5 space-y-2 text-slate-400">
            <li>
              You may update or correct your information anytime.
            </li>

            <li>
              You may request removal of your records subject to
              legal requirements.
            </li>
          </ul>
        </>
      ...
      content: (
        <>
          <p>
            ...
            reflect changes in security standards, legal
            requirements, or digital government regulations.
          </p>
        </>
      ),
    },
  ...
  return (
    <div className="min-h-screen bg-[#020c1b] text-slate-300 overflow-x-hidden relative pb-20">
        ...
        <section className="text-center mb-14">
          ...
          <FadeIn>
            ...
            <p className="text-slate-400 text-sm sm:text-base max-w-3xl mx-auto leading-8">
              ...
              Learn how we securely manage, protect,
              and process personal information inside
              the SMUC Human Resource Management System.
            </p>
            ...
            ">
              ...
              <div>
                ...
                <p className="max-w-2xl leading-8 font-medium">
                  Our data protection team is available
                  to answer questions regarding privacy,
                  account security, document protection,
                  and digital recruitment systems.
                </p>
              </div>
